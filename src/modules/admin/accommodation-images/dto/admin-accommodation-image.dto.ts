...
export const UpdateAccommodationImageSchema = z.object({
  image: z.union([CloudinaryAssetInputSchema, z.string().trim()]).optional(),
  publicId: z.string().trim().optional(),
  secureUrl: z.string().trim().url('secureUrl must be a valid URL').optional(),
  imageUrl: z.string().trim().optional(),
...
export type CreateAccommodationImageDto = z.infer<typeof CreateAccommodationImageSchema>;
export type UpdateAccommodationImageDto = z.infer<typeof UpdateAccommodationImageSchema>;
